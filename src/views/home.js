...
import {FaNodeJs,FaReact,FaHtml5,FaCss3,FaGitSquare,FaGitlab,FaDocker, FaSass,FaArrowAltCircleRight} from "react-icons/fa";
  ...
  return (
    <Container className="py-lg-5" fluid>
      <Row className="profile-teaser mx-lg-4 theme-bg-light">
        ...
        <Col xs="12" lg="5">
          <Image style={{maxHeight:300}} fluid src={require("../img/me2.jpg")} />
        </Col>
      </Row>
...
const SKILLS = [{
  ...
  icons:[{icon:FaHtml5,color:"#DE6E3C"},{color:'#53A7DC',icon:FaCss3},{color:"#BF6B97",icon:FaSass}],
